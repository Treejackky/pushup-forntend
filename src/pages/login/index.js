const Login = () => {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="font-bold text-6xl mb-5  mt-20">Login</div>
      <div className="border bg-white p-10 rounded-lg shadow-lg p-2">
        ...
        <button className="border p-2 rounded-md w-full bg-black text-white" >Sign In</button>
        <a className="mt-4 underline" href="">Forgot password?</a>
      </div>
    </div>
  );
};
