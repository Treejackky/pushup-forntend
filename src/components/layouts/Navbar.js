  ...
  return (
    <div className="flex justify-between px-5 bg-white pb-4 border-b border-gray-300">
      ...
      <div className="flex flex-row gap-5 mt-6">
        ...
        <Link to={`/${validLang}/WorkoutDetection`} className="hover:bg-gray-300 hover:rounded-full p-2 duration-200">Workout Detection</Link>
        <Link to={`/${validLang}/ProgressStats`} className="hover:bg-gray-300 hover:rounded-full p-2 duration-200">Progress & Stats</Link>
        <Link to={`/${validLang}/WorkoutPlans`} className="hover:bg-gray-300 hover:rounded-full p-2 duration-200">Workout Plans</Link>
        <Link to={`/${validLang}/Leaderboard`} className="hover:bg-gray-300 hover:rounded-full p-2 duration-200">Leaderboard</Link>
